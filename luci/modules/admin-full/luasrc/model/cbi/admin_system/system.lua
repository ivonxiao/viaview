...
local has_ntpd = nil
m = Map("system", translate("Basic Setting"), translate("Here you can configure the basic aspects of your device like its hostname or the timezone."))
m:chain("luci")


s = m:section(TypedSection, "system", translate("System Setting"))
s.anonymous = true
s.addremove = false
...
--o = s:option(DummyValue, "_date", translate("Date"))
--o.template = "admin_system/clock_date"
--
-- Logging
--
--[[
--o = s:taboption("logging", Value, "log_size", translate("System log buffer size(unit:kiB)"), "kiB")
o = s:taboption("logging", Value, "log_size", translate("System log buffer size(unit:kiB)"))
o.optional    = true
o.placeholder = 16
o.datatype    = "uinteger"
...
if has_ntpd then
	...
	if not has_section then
		...
		s = m:section(TypedSection, "timeserver", translate("Time Setting"))
		s.anonymous   = true
		s.cfgsections = function() return { "_timeserver" } end
		
		x = s:option(Button, "_enable")
		--[[
		s:tab("timeserver",  translate("Time Synchronization"))
		x = s:taboption("timeserver", Button, "_enable")
		]]--
	    ...
	    --[[
		s:tab("timeserver",  translate("Time Synchronization"))
		o = s:taboption("timeserver", Flag, "enable", translate("Enable NTP client"))
		o.rmempty = false
		]]--
